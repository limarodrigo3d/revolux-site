...
export default function SobreNos() {
  return (
    <main className="bg-white min-h-screen py-24 px-6 sm:px-10 lg:px-24 text-gray-800">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-extrabold text-center text-[#1A1A2E] mb-10">
          Sobre Nós
        </h1>

        <p className="text-lg md:text-xl text-gray-700 mb-6 leading-relaxed text-justify">
          A <strong>Revolux Certificadora Digital</strong> nasceu em 2024 da união de três irmãos
          ...
          <strong>9 anos de experiência</strong> no mercado, o que nos permite oferecer um
          atendimento altamente qualificado e diferenciado.
        </p>

        <p className="text-lg md:text-xl text-gray-700 mb-10 leading-relaxed text-justify">
          Atuamos com foco em <strong>agilidade, segurança e sigilo</strong>, tratando cada cliente
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-6 rounded-2xl shadow-md border border-gray-200 hover:shadow-lg transition duration-300 text-center">
            ...
            <p className="text-gray-600 text-sm">
              Nossa equipe se dedica a entender e atender cada cliente com empatia, paciência e
              atenção verdadeira.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl shadow-md border border-gray-200 hover:shadow-lg transition duration-300 text-center">
            ...
            <p className="text-gray-600 text-sm">
              Tratamos seus dados com total confidencialidade e as melhores práticas de proteção
              digital.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl shadow-md border border-gray-200 hover:shadow-lg transition duration-300 text-center">
            ...
            <p className="text-gray-600 text-sm">
              Com anos de experiência, realizamos os processos com eficiência e rapidez sem abrir
              mão da qualidade.
            </p>
          </div>
        </div>

        <p className="text-center text-lg md:text-xl text-[#1A1A2E] font-medium mt-16">
          Revolux Certificadora Digital — A confiança que você busca, com a experiência que você
          merece.
        </p>
      </motion.div>
    </main>
